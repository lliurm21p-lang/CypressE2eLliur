class InventorySDP {
  ...
  get addTShirt() { return cy.get('[data-test="add-to-cart-sauce-labs-bolt-t-shirt"]'); }

  get addBikeLight() { return cy.get('[data-test="add-to-cart-sauce-labs-bike-light"]');}

  get removeBackpackBtn() { return cy.get('[data-test="remove-sauce-labs-backpack"]'); }
  
  get cartBadge() { return cy.get('.shopping_cart_link'); }
